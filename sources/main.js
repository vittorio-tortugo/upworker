...
(function() {
  var freshJobsButton, get_jobs_elements, init_counters, is_in_find_work_page, is_should_show_counters, load_counters_data_for, moreJobsButton, pseudo_callback, show_counters;

  is_in_find_work_page = function() {
    return location.pathname.indexOf('find-work-home') > -1;
  };
